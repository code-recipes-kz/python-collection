# Этот код решает систему линейных алгебраических уравнений вида Ax = B,
# где A - матрица коэффициентов, B - столбец свободных членов,
# x - столбец неизвестных. Прямой ход метода Гаусса приводит матрицу A к
# верхнетреугольному виду, а обратный ход вычисляет значения неизвестных x.
